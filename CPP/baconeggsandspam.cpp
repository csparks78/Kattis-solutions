...
void displayMenuName(vector<string> menu, vector<string> name, vector<string> orderInfo);
...
int main()
{
    ...
    while(customer != 0)
    {
        ...
        copy(menuSet.begin(), menuSet.end(), back_inserter(menuVec)); //convert set into vector for sorting
